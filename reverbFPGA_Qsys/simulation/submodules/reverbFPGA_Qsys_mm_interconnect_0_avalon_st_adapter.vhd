-- reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter.vhd
...
entity reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter is
	generic (
		inBitsPerSymbol : integer := 34;
		inUsePackets    : integer := 0;
		inDataWidth     : integer := 34;
	...
	port (
		...
		in_0_data      : in  std_logic_vector(33 downto 0) := (others => '0'); --     in_0.data
		in_0_valid     : in  std_logic                     := '0';             --         .valid
		in_0_ready     : out std_logic;                                        --         .ready
		out_0_data     : out std_logic_vector(33 downto 0);                    --    out_0.data
		out_0_valid    : out std_logic;                                        --         .valid
		out_0_ready    : in  std_logic                     := '0';             --         .ready
		out_0_error    : out std_logic_vector(0 downto 0)                      --         .error
	);
end entity reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter;

architecture rtl of reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter is
	component reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter_error_adapter_0 is
		port (
	...
	end component reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter_error_adapter_0;

	signal in_rst_0_reset_ports_inv : std_logic; -- in_rst_0_reset:inv -> error_adapter_0:reset_n

begin

	inbitspersymbol_check : if inBitsPerSymbol /= 34 generate
	...
	indatawidth_check : if inDataWidth /= 34 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	outdatawidth_check : if outDataWidth /= 34 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
	...
	error_adapter_0 : component reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter_error_adapter_0
		port map (
...
end architecture rtl; -- of reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter
