...
# ----------------------------------------
# If reverbFPGA_Qsys is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "reverbFPGA_Qsys"
}
...
ensure_lib                                                    ./libraries/altclkctrl_inst                                   
vmap       altclkctrl_inst                                    ./libraries/altclkctrl_inst                                   
...
ensure_lib                                                    ./libraries/audio_config_avalon_av_config_slave_burst_adapter 
vmap       audio_config_avalon_av_config_slave_burst_adapter  ./libraries/audio_config_avalon_av_config_slave_burst_adapter 
...
ensure_lib                                                    ./libraries/audio_config_avalon_av_config_slave_agent_rsp_fifo
vmap       audio_config_avalon_av_config_slave_agent_rsp_fifo ./libraries/audio_config_avalon_av_config_slave_agent_rsp_fifo
ensure_lib                                                    ./libraries/audio_config_avalon_av_config_slave_agent         
vmap       audio_config_avalon_av_config_slave_agent          ./libraries/audio_config_avalon_av_config_slave_agent         
...
ensure_lib                                                    ./libraries/audio_config_avalon_av_config_slave_translator    
vmap       audio_config_avalon_av_config_slave_translator     ./libraries/audio_config_avalon_av_config_slave_translator    
...
ensure_lib                                                    ./libraries/serial_flash_loader                               
vmap       serial_flash_loader                                ./libraries/serial_flash_loader                               
ensure_lib                                                    ./libraries/paramValueUpdate_PIO                              
vmap       paramValueUpdate_PIO                               ./libraries/paramValueUpdate_PIO                              
ensure_lib                                                    ./libraries/paramType_PIO                                     
vmap       paramType_PIO                                      ./libraries/paramType_PIO                                     
...
alias com {
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv"  -l altera_common_sv_packages -work error_adapter_0                                   
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_serial_flash_loader_altclkctrl_inst_altclkctrl_inst.vhd"                              -work altclkctrl_inst                                   
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_hps_0_hps_io_border_memory.sv"                           -l altera_common_sv_packages -work border                                            
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_hps_0_hps_io_border_hps_io.sv"                           -l altera_common_sv_packages -work border                                            
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_hps_0_hps_io_border.sv"                                  -l altera_common_sv_packages -work border                                            
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_mm_interconnect_0_avalon_st_adapter.vhd"                                              -work avalon_st_adapter                                 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_mm_interconnect_0_rsp_mux.sv"                            -l altera_common_sv_packages -work rsp_mux                                           
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_mm_interconnect_0_rsp_demux.sv"                          -l altera_common_sv_packages -work rsp_demux                                         
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_mm_interconnect_0_cmd_mux.sv"                            -l altera_common_sv_packages -work cmd_mux                                           
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_mm_interconnect_0_cmd_demux.sv"                          -l altera_common_sv_packages -work cmd_demux                                         
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                                          -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_uncmpr.sv"                                   -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"                                     -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"                                      -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"                                          -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"                                          -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"                                       -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                      -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"                                      -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                        -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_burst_adapter 
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_mm_interconnect_0_router_002.sv"                         -l altera_common_sv_packages -work router_002                                        
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_mm_interconnect_0_router.sv"                             -l altera_common_sv_packages -work router                                            
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                                              -work audio_config_avalon_av_config_slave_agent_rsp_fifo
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                            -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_agent         
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                     -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_agent         
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                       -l altera_common_sv_packages -work audio_config_avalon_av_config_slave_translator    
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/altclkctrl_inst.vhd"                                                                                  -work altclkctrl_inst                                   
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_hps_0_hps_io.v"                                                                       -work hps_io                                            
  ...
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_hps_0_fpga_interfaces_h2f_mpu_events.sv"                 -l altera_common_sv_packages -work fpga_interfaces                                   
  eval  vlog  $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_hps_0_fpga_interfaces.sv"                                -l altera_common_sv_packages -work fpga_interfaces                                   
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_mm_interconnect_0.v"                                                                  -work mm_interconnect_0                                 
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_serial_flash_loader.v"                                                                         -work serial_flash_loader                               
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_paramValueUpdate_PIO.vhd"                                                             -work paramValueUpdate_PIO                              
  ...
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/reverbFPGA_Qsys_hps_0.v"                                                                              -work hps_0                                             
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L altera_common_sv_packages -L error_adapter_0 -L altclkctrl_inst -L border -L avalon_st_adapter -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L audio_config_avalon_av_config_slave_burst_adapter -L hps_0_h2f_lw_axi_master_wr_limiter -L router_002 -L router -L audio_config_avalon_av_config_slave_agent_rsp_fifo -L audio_config_avalon_av_config_slave_agent -L hps_0_h2f_lw_axi_master_agent -L audio_config_avalon_av_config_slave_translator -L hps_io -L fpga_interfaces -L rst_controller -L mm_interconnect_0 -L serial_flash_loader -L paramValueUpdate_PIO -L paramType_PIO -L hps_0 -L dampingValue_PIO -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev -L cyclonev_hssi $TOP_LEVEL_NAME
}
